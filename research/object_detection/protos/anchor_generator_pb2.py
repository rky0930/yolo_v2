...
import object_detection.protos.yolo_anchor_generator_pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='object_detection/protos/anchor_generator.proto',
  package='object_detection.protos',
  serialized_pb=_b('\n.object_detection/protos/anchor_generator.proto\x12\x17object_detection.protos\x1a\x33object_detection/protos/grid_anchor_generator.proto\x1a\x32object_detection/protos/ssd_anchor_generator.proto\x1a\x33object_detection/protos/yolo_anchor_generator.proto\"\x96\x02\n\x0f\x41nchorGenerator\x12M\n\x15grid_anchor_generator\x18\x01 \x01(\x0b\x32,.object_detection.protos.GridAnchorGeneratorH\x00\x12K\n\x14ssd_anchor_generator\x18\x02 \x01(\x0b\x32+.object_detection.protos.SsdAnchorGeneratorH\x00\x12M\n\x15yolo_anchor_generator\x18\x03 \x01(\x0b\x32,.object_detection.protos.YoloAnchorGeneratorH\x00\x42\x18\n\x16\x61nchor_generator_oneof')
  ,
  dependencies=[object_detection.protos.grid_anchor_generator_pb2.DESCRIPTOR,object_detection.protos.ssd_anchor_generator_pb2.DESCRIPTOR,object_detection.protos.yolo_anchor_generator_pb2.DESCRIPTOR,])
...
_ANCHORGENERATOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='yolo_anchor_generator', full_name='object_detection.protos.AnchorGenerator.yolo_anchor_generator', index=2,
...
_ANCHORGENERATOR.fields_by_name['yolo_anchor_generator'].message_type = object_detection.protos.yolo_anchor_generator_pb2._YOLOANCHORGENERATOR
...
_ANCHORGENERATOR.oneofs_by_name['anchor_generator_oneof'].fields.append(
  _ANCHORGENERATOR.fields_by_name['yolo_anchor_generator'])
_ANCHORGENERATOR.fields_by_name['yolo_anchor_generator'].containing_oneof = _ANCHORGENERATOR.oneofs_by_name['anchor_generator_oneof']
