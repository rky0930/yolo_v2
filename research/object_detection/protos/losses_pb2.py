...
_CLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='confidence_weighted_sigmoid', full_name='object_detection.protos.ClassificationLoss.confidence_weighted_sigmoid', index=4,
...
_CONFIDENCEWEIGHTEDSIGMOIDCLASSIFICATIONLOSS = _descriptor.Descriptor(
  name='ConfidenceWeightedSigmoidClassificationLoss',
  full_name='object_detection.protos.ConfidenceWeightedSigmoidClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='object_detection.protos.ConfidenceWeightedSigmoidClassificationLoss.anchorwise_output', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='object_scale', full_name='object_detection.protos.ConfidenceWeightedSigmoidClassificationLoss.object_scale', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='noobject_scale', full_name='object_detection.protos.ConfidenceWeightedSigmoidClassificationLoss.noobject_scale', index=2,
...
_CLASSIFICATIONLOSS.fields_by_name['confidence_weighted_sigmoid'].message_type = _CONFIDENCEWEIGHTEDSIGMOIDCLASSIFICATIONLOSS
...
_CLASSIFICATIONLOSS.oneofs_by_name['classification_loss'].fields.append(
  _CLASSIFICATIONLOSS.fields_by_name['confidence_weighted_sigmoid'])
_CLASSIFICATIONLOSS.fields_by_name['confidence_weighted_sigmoid'].containing_oneof = _CLASSIFICATIONLOSS.oneofs_by_name['classification_loss']
...
DESCRIPTOR.message_types_by_name['ConfidenceWeightedSigmoidClassificationLoss'] = _CONFIDENCEWEIGHTEDSIGMOIDCLASSIFICATIONLOSS
...
ConfidenceWeightedSigmoidClassificationLoss = _reflection.GeneratedProtocolMessageType('ConfidenceWeightedSigmoidClassificationLoss', (_message.Message,), dict(
  DESCRIPTOR = _CONFIDENCEWEIGHTEDSIGMOIDCLASSIFICATIONLOSS,
  __module__ = 'object_detection.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.ConfidenceWeightedSigmoidClassificationLoss)
  ))
_sym_db.RegisterMessage(ConfidenceWeightedSigmoidClassificationLoss)
