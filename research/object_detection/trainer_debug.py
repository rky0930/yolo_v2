...
def get_inputs(input_queue, num_classes, merge_multiple_label_boxes=False):
  ...
  def extract_images_and_targets(read_data):
    ...
    print(image)
    global_summaries.add(tf.summary.image('image', image, 3))
    key = ''
...
def train(create_tensor_dict_fn, create_model_fn, train_config, master, task,
  ...
  with tf.Graph().as_default():
    ...
    # tfgdb - threa_name_filter
    session_wrapper_main_thread =  functools.partial(
      tf_debug.LocalCLIDebugWrapperSession,
      dump_root="/home/yoon/workspace/git_rky0930/local_run/object_detection/model/darknet_19/dump",
